...
Open its Share pane, keep access invite-only, and invite Teammate A and Teammate B to
the project if they are not already members. Chat access is sufficient for creating
their own conversations; give edit access only when they need to change shared
files/instructions. These invitations are separate from GitHub access.
...
|---|---|---|
| Lead | Lead — Integration | chat-starters/Lead.md |
| Teammate A | Teammate A — Pet UI & Visuals | chat-starters/Teammate-A.md |
| Teammate B | Teammate B — Community UI & QA | chat-starters/Teammate-B.md |
...
The lead can add PROJECT_BRIEF.md, OWNERSHIP.md, and the three role packs to project sources.
...
every speaker is the lead. Suggested shared instructions are in PROJECT_INSTRUCTIONS.md.
