# Teammate B — new ChatGPT project chat

Paste the text below as the first message in a new chat inside OKX Hackathon.

---

This is the community-UI and QA chat for MemePet. I am Teammate B and have minimal
coding experience.

Read docs/prompt-packs/TEAMMATE-B.md. I own src/components/landing/**,
