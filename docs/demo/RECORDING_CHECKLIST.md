...
- [ ] Use your [individual script](DEMO_SCRIPT.md#speakers-and-recording-pack). Separate clips by scene ID, slate the ID, speak naturally and leave two-second handles.
